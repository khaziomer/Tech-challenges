...
export default function Contact() {
  ...
  const handleSubmit = (e) => {
    ...
    window.location.href = `mailto:info@techchallenges.sa?subject=Contact%20Form%20Submission&body=Name:%20${name}%0AEmail:%20${email}%0AMessage:%20${message}`;
  };
      ...
      <div className="bg-gradient-to-t from-blue-950 to-gray-200 min-h-screen p-8">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-8">
            ...
            <div className="bg-white p-6 rounded-lg shadow-md">
              <h2 className="text-2xl font-bold text-blue-950 mb-13 mt-5">
                Contact Information
              </h2>
              <p className="text-gray-700 mb-4">
                <strong>Phone:</strong>{" "}
              ...
              <p className="text-gray-700 mb-4">
                <strong>Address:</strong> Riyadh, Kingdom of Saudi Arabia
              </p>
              <p className="text-gray-700 mb-4">
                <strong>Office Hours:</strong> Monday to Thursday, 9:00 AM to
                6:00 PM
              </p>
              <p className="text-gray-700 mb-4">
                <strong>Support:</strong> For support inquiries, please email{" "}
                <a
